                        ...
                        {tab === "guide" && (
                            <>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        연습 영상은 <b>마이페이지 → 연습 기록</b>에 저장되며, 언제든
                                        확인할 수 있습니다.
                                    </li>
                                    <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        화상면접 종료 시 <b>나가기 버튼</b>을 통해 종료할 수
                                        있습니다.
                                    </li>
                                    <li>
                                        면접 영상은 <b>마이페이지 → 화상면접 기록</b>에서 확인할 수
                                        있습니다.
                                    </li>
                                </ul>
                                ...
                                <ul>
                                    <li>
                                        <b>프로필 수정</b>에서 회원 정보를 수정할 수 있습니다.
                                    </li>
                                    <li>* 아이디와 이메일은 수정할 수 없습니다.</li>
                                    <li>
                                        <b>예약 일정</b>에서 내가 예약한 일정과 종료된 일정을 확인할
                                        수 있습니다.
                                    </li>
                                    <li>
                                        일정을 변경하고 싶으실 경우, <b>일정 변경</b>을 선택하여
                                        변경할 수 있습니다.
                                    </li>
                                    <li>* 컨설턴트는 변경할 수 없습니다.</li>
                                    <li>
                                        종료된 일정의 <b>컨설턴트 평가</b>를 통해 컨설턴트의 별점을
                                        남길 수 있습니다.
                                    </li>
                                    <li>
                                        <b>화상면접 기록</b>에서 <b>1:1 화상면접 영상</b>을 확인할
                                        수 있어, 컨설턴트 피드백 내용을 복기할 수 있습니다.
                                    </li>
                                    <li>
                                        <b>연습 기록</b>에서 <b>나 혼자 연습 영상</b>을 확인할 수
                                        있어, 스스로 피드백을 할 수 있습니다.
                                    </li>
                                    <li>
                                        <b>구독/결제 내역</b>에서{" "}
                                        <b>
                                            내가 구매한 이용권과 이용 가능 기간 및 이용 횟수, 결제
                                            내역
                                        </b>
                                        을 확인할 수 있습니다.
                                    </li>
                                    <li>* 이용 가능 기간이 지난 이용권은 환불 불가합니다.</li>
                                    <li>
                                        <b>결제 취소</b>를 통해 환불이 가능합니다.
                                    </li>
                                </ul>
                            </>
                        )}
